<?php 
class TIG_Afterpay_Model_Response_Capture extends TIG_Afterpay_Model_Response_Abstract
{    
    protected $_invoice;
    ...
    protected function _accept()
    {
        ...
        $this->_order->setStatus(Mage::getStoreConfig('afterpay/afterpay_capture/order_status_accepted', Mage::app()->getStore()->getId()))
                     ->save();
    ...
    protected function _validation()
    {
        ...
        $this->_order->setStatus(Mage::getStoreConfig('afterpay/afterpay_capture/order_status_refused', Mage::app()->getStore()->getId()))
                     ->save();
    ...
    protected function _storeTransactionId()
    {
        ...
        if (!$this->_invoice->getTransactionId()  && !empty($reference)) {
