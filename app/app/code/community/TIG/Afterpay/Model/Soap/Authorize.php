<?php 
class TIG_Afterpay_Model_Soap_Authorize extends TIG_Afterpay_Model_Soap_Abstract
{
    ...
    protected function _addShopDetails()
    {
        ...
        $shopDetails->afterpayPluginVersion  = Mage::getConfig()->getModuleConfig("TIG_Afterpay")->version;
